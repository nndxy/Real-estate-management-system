			...
			<div class="tab-pane fade in active" id="renttab">
				<form id="tab0" class="col-lg-10  form-horizontal" id="rent" method="post" action="pubWanted">
					...
					<div class="form-group">
						<div class="col-lg-8">
							<label>面积</label>
							<input type="number"  name="wanted.minArea"  required="required" />
							<label>----</label>
							<input type="number" name="wanted.maxArea"  required="required" />
							<label>平米</label>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-8">
							<label>价格</label>
							<input type="number" required="required" name="wanted.maxPrice" />
							<label>元/平米</label>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-8">
							<label>联系电话</label>		
							<input type="number" required="required" name="wanted.userTel"/>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-8">
